...
<img src={lifecycleImg.src} alt="SATF Trust Lifecycle" class="w-full h-auto rounded-xl" />
</Callout>
...
<ArchitectureNote title="Validation Discovers, Governance Decides, Enforcement Applies" type="info">
