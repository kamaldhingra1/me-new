...
import lifecycleImg from "@/assets/images/posts/satf/trust_lifecycle.png";
import trustplaneImg from "@/assets/images/posts/satf/concept_trust_plane.png";
import crosscuttingImg from "@/assets/images/posts/satf/crosscutting_control_plane.png";
import responseImg from "@/assets/images/posts/satf/response_plane.png";
...
### Safe, Trusted, Compliant, Resilient, and Expected Outcomes =>
  ...
  <img 
    ...
    alt="SATF Baseline 1.0 Framework"
...
<Callout type="Sol" title="The core premise is simple:">
...
<ArchitectureNote type="success" title="SATF helps organizations achieve:">
...
<ArchitectureNote2 type="success" title="A secure outcome is:">
...
<ArchitectureNote2 type="insight2" title="Core Principal & Goal">
...
<Callout type="Sol" title="Trust Lifecycle">
            **Establish → Enforce → Validate → Reassess → Adapt → Contain / Re-establish**
</Callout>
<img src={lifecycleImg.src} alt="SATF Trust Lifecycle" class="w-full h-auto rounded-xl" width="100%" />
...
<Callout type="Sol" title="SATF Three Views">
...
<img src={trustplaneImg.src} alt="Conceptual Trust Plane" class="w-full h-auto rounded-xl" />
<Callout type="tip" title="It contains:">
...
<img src={crosscuttingImg.src} alt="Cross-Cutting Control Plane" class="w-full h-auto rounded-xl"       style={{ width: '100%', height: '120%' }}/>
...
<ArchitectureNote2 title="Validation Discovers, Governance Decides, Enforcement Applies" type="info">
 - SATF separates responsibilities. 

 - Ring 3 produces validation evidence. 

 - The cross-cutting control plane turns evidence into adaptive policy. 

 - Ring 2 enforces the policy at runtime.
</ArchitectureNote2>
...
<img src={responseImg.src}alt="Runtime & Response Plane" class="w-full h-auto rounded-xl" />

<Callout type="Sol" title="It includes:">
...
<ArchitectureNote2 type="insight2">
  Trust lifecycle + Trust fabric + Trust rings 
                +
    Control plane + Runtime response 
      --> Secure Outcomes
</ArchitectureNote2>
