...
pubDatetime: 2026-07-20T04:58:53Z
tags:
- AI Security
- Agentic AI
- Agent Security
...
<div class="rounded-xl border border-fuchsia-300/70  p-2 dark:border-fuchsia-500/40 dark:bg-fuchsia-950/25">
...
![Traditional Security vs Agentic AI Security](../../../assets/images/posts/ai/conseca-traditional-vs-agentic-security.png)

<Callout type="intro" title="Traditional vs Agentic Security">
...
<Callout type="intro" title="Scenario 1">
...
<Callout type="danger" title="Scenario 2">
User request:
...
![Context Determines Whether an Agent Action Is Safe](../../../assets/images/posts/ai/conseca-context-determines-safety.png)

**This is arguably the most important lesson from the paper.**
<Callout type="Exe" title="Security decisions may increasingly depend on:">
...
<Callout type="Sol" title="Conseca Dynamic Policy on:">
- **User request**
- **Trusted context**
...
<Callout type="Exe" title="Conseca Authorization Boundary">
...
![Conseca Contextual Agent Security Flow](../../../assets/images/posts/ai/conseca-contextual-agent-security-flow.png)
...
<ArchitectureNote2 type="insight2" title="My Interpretation">
...
<div class="rounded-xl border border-blue-300/70  p-4 dark:border-fuchsia-500/40 dark:bg-fuchsia-950/25">
<h3> AI-Native Businesses</h3>
...
![Three Stakeholder Lenses for Contextual Agent Security](../../../assets/images/posts/ai/conseca-three-stakeholder-lenses.png)
...
![The Evolution of Security](../../../assets/images/posts/ai/conseca-security-evolution.png)

<Callout type="intro" title="Evolution of Security">
...
<ArchitectureNote2 type="insight2" title="Looking Ahead">
